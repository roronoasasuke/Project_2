...
import { createVideoSchema, searchQuerySchema } from '@/lib/validation'
...
export async function GET(req: NextRequest) {
	...
	return NextResponse.json({ items: videos, page, limit, total })
}
...
export async function POST(req: NextRequest) {
	...
	const video = await Video.create({ ...parsed.data, ownerId: auth.userId })
